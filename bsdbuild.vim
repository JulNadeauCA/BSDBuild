" Vim syntax file
" Language:		BSDBuild mkconfigure(1) source
" Maintainer:		Julien Nadeau Carriere <vedge@csoft.net>
" Last Change:		Dec 10, 2018
" Version:		1
" URL:		http://bsdbuild.hypertriton.com/download.html
...
" BSDBuild Keywords: {{{1
" ===================
syn keyword shStatement package version release register register_env_var
